        ...
        <div class="col-xs-12 col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    <form method="post" action="{{ route('save-chat')}} " id="form-chat">
                            <!-- CSRF Token -->
...
@section('footer')
    ...
    <script>
        ...
        var receive = '<div class="row msg_container base_receive">'+
                        ...
                        '<div class="col-md-10 col-xs-10"><div class="messages msg_receive"><p>'+message.message+
                                '</p><time datetime="2009-11-13T20:00">Timothy • 51 min</time></div></div></div>';
            // increase the power everytime we load test route
            $(".panel-body").append(receive);
